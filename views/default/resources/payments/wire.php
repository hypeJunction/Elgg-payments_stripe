...
$instructions = str_replace('{{invoice}}', $transaction->guid, $transaction->stripe_instructions);
...
$content = elgg_view_module('aside', elgg_echo('payments:stripe:instructions'), $instructions);
